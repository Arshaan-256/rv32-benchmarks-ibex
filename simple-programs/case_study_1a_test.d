...
0x000000f0:      bltu x17,x5,$HALT
0x000000f4:      bne x17,x5,$CONTINUE_WH
0x000000f8:      bltu x16,x4,$HALT
#
#
# Write Hits (x12, x25)
# x7, x6  = x12 * x25
...
0x00000114:      bltu x17,x5,$HALT
0x00000118:      bne x17,x5,$CONTINUE_WM
0x0000011c:      bltu x16,x4,$HALT
#
#
...
0x00000138:      bltu x17,x5,$HALT
0x0000013c:      bne x17,x5,$NO_HALT
0x00000140:      bltu x16,x4,$HALT
#
#
